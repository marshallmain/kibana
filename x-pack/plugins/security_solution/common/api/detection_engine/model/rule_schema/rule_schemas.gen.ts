...
export type EqlRuleResponseFields = RequiredOptional<z.infer<typeof EqlRuleResponseFields>>;
...
export type QueryRuleResponseFields = RequiredOptional<z.infer<typeof QueryRuleResponseFields>>;
...
export type SavedQueryRuleResponseFields = RequiredOptional<
  z.infer<typeof SavedQueryRuleResponseFields>
>;
...
export type ThresholdRuleResponseFields = RequiredOptional<
  z.infer<typeof ThresholdRuleResponseFields>
>;
...
export type ThreatMatchRuleResponseFields = RequiredOptional<
  z.infer<typeof ThreatMatchRuleResponseFields>
>;
...
export type NewTermsRuleResponseFields = RequiredOptional<
  z.infer<typeof NewTermsRuleResponseFields>
>;
...
const test = (input: TypeSpecificResponse) => {
  if (input.type === 'query') {
    input.alert_suppression;
  }
};
