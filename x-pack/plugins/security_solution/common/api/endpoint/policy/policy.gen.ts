...
export type GetAgentPolicySummaryResponse = RequiredOptional<
  z.infer<typeof GetAgentPolicySummaryResponse>
>;
...
export type GetPolicyResponseResponse = RequiredOptional<z.infer<typeof GetPolicyResponseResponse>>;
